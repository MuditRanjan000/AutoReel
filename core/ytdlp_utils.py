...
def extend_with_cookies(cmd: list) -> list:
    ...
    # Add iOS/Web clients to bypass YouTube SABR streaming block
    cmd.extend(["--extractor-args", "youtube:player-client=ios,web,mweb"])
    
    # Add generic Deno JS runtime flag to bypass YouTube 'n challenge' bot protection
