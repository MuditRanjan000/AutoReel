...
4. Aesthetic Match: Does the clip's style align with the channel's DNA? (DemoChannel: dark cinematic moody silhouette rain monochrome; ExampleChannel: raw news, CCTV, bodycam, evidence; DemoChannel: authentic vlog style).
...
- Cricket (DemoChannel): Wrong Sport (e.g., soccer, football, baseball) = Immediate Reject (accept = False, score = 0). Mismatched teams (e.g., Australian cricket shown when narration is about West Indies) = Reject.
- Crime (ExampleChannel): Reject generic police sirens, generic stock handcuffs/cops, or random suspects when the narration is about a specific case/person (e.g., Lars Mittank). Real news footage, Varna Airport, CCTV, or actual case photos must be accepted.
- Stoic (DemoChannel): Must depict the correct mood (meditation, monk, contemplation, dark cinematic visuals). Reject cheerful stock, athletes, corporate offices, or blacksmiths when monks/philosophy are narrated.
- Culture (DemoChannel): Must show the correct demographics and culture (e.g. Nepalese dating culture must show Nepalese/South Asian people and settings). Reject generic Western stock couples or European models.
