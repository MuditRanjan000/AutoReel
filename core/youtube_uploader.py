...
class YouTubeUploader:
    ...
    def authenticate(self, ctx=None):
        ...
        if ctx is not None:
            ...
            channel_name = os.environ.get("ACTIVE_CHANNEL", "demo_channel").strip()
    ...
    def upload(self, video_path: str, thumbnail_path: str,
        ...
        try:
            ...
            # Set thumbnail in an isolated try-except so thumbnail rejection (e.g. unverified phone number)
            # never masks a successful video upload or causes duplicate uploads.
            if os.path.exists(thumbnail_path):
                try:
                    ...
                    print(f"[YouTube] ⚠️ Warning: Failed to set custom thumbnail ({thumb_err}). Video remains successfully published.")
