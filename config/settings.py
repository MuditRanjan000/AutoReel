...
GROQ_MODEL    = "openai/gpt-oss-120b"   # Active high-throughput primary model on Groq
...
_active_channel_file = os.environ.get("ACTIVE_CHANNEL", "example_channel") + ".json"
...
CHANNEL_NAME         = _chan.get("CHANNEL_NAME", "DemoChannel")
