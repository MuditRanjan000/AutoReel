...
## 🚨 HIGH-ENGAGEMENT CTA RULE (CRITICAL)
The Call-To-Action (CTA) at the end of the script MUST be exactly 1 sentence. It must drive engagement through a debate-driving open question or a focused comment prompt.
BANNED: Never use generic begging like "like and subscribe" or "follow for more".
